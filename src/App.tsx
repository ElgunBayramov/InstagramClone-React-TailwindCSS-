    ...
    <div className="w-full h-full flex flex-wrap overflow-auto items-center gap-x-8 justify-center">
      ...
      <div className='bg-white border px-[40px] pt-10 pb-2'>
        ...
        <form className='grid gap-y-1'>
          ...
          <button type='submit' disabled={!enable} className='h-[32px] rounded-lg mt-2 bg-loginbtn text-white font-medium text-sm disabled:opacity-50 hover:bg-loginbtnhover'>Log In</button>
      ...
      Don't have an account? <a href='#' className='font-semibold text-loginbtn'>Sign up</a>
      </div>
      </div>
    </div>
  );
